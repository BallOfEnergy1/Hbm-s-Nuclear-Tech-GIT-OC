...
public class TileEntitySoyuzLauncher extends TileEntityMachineBase implements ISidedInventory, IEnergyReceiver, IFluidContainer, IFluidAcceptor, IFluidStandardReceiver, IGUIProvider {
