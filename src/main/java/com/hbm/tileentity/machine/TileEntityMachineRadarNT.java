...
public class TileEntityMachineRadarNT extends TileEntityMachineBase implements IEnergyReceiver, IGUIProvider, IConfigurableMachine, IControlReceiver, SimpleComponent, CompatHandler.OCComponent {
