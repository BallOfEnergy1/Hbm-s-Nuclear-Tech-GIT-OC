...
public class TileEntityElectrolyser extends TileEntityMachineBase implements IEnergyReceiver, IFluidStandardTransceiver, IControlReceiver, IGUIProvider, IUpgradeInfoProvider {
