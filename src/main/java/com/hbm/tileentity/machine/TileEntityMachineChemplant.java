...
public class TileEntityMachineChemplant extends TileEntityMachineBase implements IEnergyReceiver, IFluidStandardTransceiver, IGUIProvider, IUpgradeInfoProvider {
