...
public class TileEntityMachineSolidifier extends TileEntityMachineBase implements IEnergyReceiver, IFluidAcceptor, IFluidStandardReceiver, IGUIProvider, IUpgradeInfoProvider, IInfoProviderEC {
