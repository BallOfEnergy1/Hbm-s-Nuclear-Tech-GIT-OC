...
public class TileEntityMachineLiquefactor extends TileEntityMachineBase implements IEnergyReceiver, IFluidSource, IFluidStandardSender, IGUIProvider, IUpgradeInfoProvider, IInfoProviderEC {
