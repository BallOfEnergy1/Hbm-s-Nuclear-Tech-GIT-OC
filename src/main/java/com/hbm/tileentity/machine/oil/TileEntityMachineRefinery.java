...
public class TileEntityMachineRefinery extends TileEntityMachineBase implements IEnergyReceiver, IOverpressurable, IPersistentNBT, IRepairable, IFluidStandardTransceiver, IGUIProvider {
