...
public class TileEntityMachineMiningLaser extends TileEntityMachineBase implements IEnergyReceiver, IFluidSource, IMiningDrill, IFluidStandardSender, IGUIProvider, IUpgradeInfoProvider {
